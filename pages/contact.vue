      ...
      <div class="page-reveal reveal-delay-1 space-y-8">
        <div class="space-y-6">
          ...
          <p class="max-w-3xl text-sm leading-7 text-[#41555d] sm:text-base">
            Reach us for fleet deployment, charging infrastructure, public transport programmes,
            shared mobility, partnerships, or long-term EV support planning.
          </p>
        </div>
          ...
          <div class="page-reveal reveal-delay-2 rounded-[2rem] border border-[#d8dfd5] bg-[#101920] p-6 text-white shadow-[0_24px_80px_rgba(16,32,39,0.12)] sm:p-8">
            ...
            <div class="mt-6 space-y-5">
              <a href="tel:+2349041595102" class="block rounded-[1.35rem] border border-white/10 bg-white/5 p-4 transition-colors duration-300 hover:bg-white/8">
                ...
                <p class="mt-2 text-lg font-medium text-white/90">+234 904 159 5102</p>
              </a>
              <a href="mailto:ev@metropolitanelectricng.com" class="block rounded-[1.35rem] border border-white/10 bg-white/5 p-4 transition-colors duration-300 hover:bg-white/8">
                <p class="text-[11px] uppercase tracking-[0.24em] text-white/40">Email</p>
                <p class="mt-2 break-all text-lg font-medium text-white/90">ev@metropolitanelectricng.com</p>
              </a>
              <a
              ...
              >
                ...
                <p class="mt-2 text-base leading-7 text-white/84">
                  Metropolitan Electric Limited, 77 Sinari Daranijo St, Victoria Island, Lagos 106104, Lagos
                </p>
              </a>
            </div>
          </div>
          ...
          <section class="page-reveal reveal-delay-3 rounded-[2rem] border border-[#d8dfd5] bg-white/92 p-6 shadow-[0_22px_70px_rgba(16,32,39,0.07)] backdrop-blur-sm sm:p-8">
            ...
            <form ref="form" method="post" @submit.prevent="sendEmail" class="mt-8 space-y-5">
              <div class="grid gap-5 sm:grid-cols-2">
                <label class="block">
                  <span class="mb-2 block text-[11px] font-semibold uppercase tracking-[0.22em] text-[#6b8177]">Name</span>
                  <input
                    type="text"
                    name="from_name"
                ...
                <label class="block">
                  <span class="mb-2 block text-[11px] font-semibold uppercase tracking-[0.22em] text-[#6b8177]">Email</span>
                  <input
                    type="email"
                    name="from_email"
                    class="w-full rounded-[1.15rem] border border-[#d9e1d7] bg-[#fdfefd] px-4 py-3 text-sm text-[#101920] placeholder:text-[#7a8d84] focus:outline-none focus:ring-2 focus:ring-[#101920]/15"
              ...
              <label class="block">
                <span class="mb-2 block text-[11px] font-semibold uppercase tracking-[0.22em] text-[#6b8177]">Message</span>
                <textarea
                  rows="6"
                  name="message"
              ...
              <div class="flex items-start gap-3 rounded-[1.2rem] bg-[#fbfdfb] p-4">
                ...
                <label for="contact-consent" class="text-sm leading-7 text-[#41555d]">
                  I allow Metropolitan Electric to store this enquiry and contact me about the request.
                </label>
              </div>
