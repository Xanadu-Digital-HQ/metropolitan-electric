...
useSeoMeta({
  ...
  description:
    "Learn how Metropolitan Electric is building a cleaner EV ecosystem across Africa through fleets, charging infrastructure, assembly, and long-term mobility support.",
  ogDescription:
    "Learn how Metropolitan Electric is building a cleaner EV ecosystem across Africa through fleets, charging infrastructure, assembly, and long-term mobility support.",
...
const pillars = [
  {
    ...
    description:
      "We do not treat electric mobility as a single vehicle sale. We design around fleets, charging access, service support, and operational continuity.",
    icon: PhStrategy,
  },
  {
    title: "African Operating Context",
    description:
      "Our approach is shaped by real transport conditions, infrastructure realities, and the economic logic required for adoption across African markets.",
    icon: PhGlobeHemisphereWest,
  },
  {
    title: "Long-Term Reliability",
    description:
      "From rollout to maintenance, the goal is durable performance, cleaner operations, and a more dependable mobility stack over time.",
    icon: PhShieldCheck,
  },
] as const;
...
const valueCards = [
  {
    title: "Electrification With Purpose",
    copy:
      "Every EV deployment should create cleaner movement, lower friction, and better operational outcomes for the people using it.",
    icon: PhLeaf,
  },
  {
    title: "Infrastructure Matters",
    copy:
      "Vehicle adoption only scales when charging, maintenance, and support systems are considered from the start.",
    icon: PhBatteryCharging,
  },
  {
    title: "Built For Operators",
    copy:
      "We design around institutions, fleet owners, transport systems, and real-world operators instead of abstract innovation claims.",
    icon: PhUsersThree,
  },
  {
    title: "Modern Mobility Discipline",
    copy:
      "The EV future is not just cleaner. It should also be more structured, more resilient, and easier to run at scale.",
    icon: PhLightning,
  },
] as const;
...
const operatingModel = [
  {
    ...
    detail: "Corporate and institutional EV rollout designed around usage patterns and operational fit.",
    icon: PhBuildings,
  },
  {
    label: "Charging Access",
    detail: "Infrastructure planning that supports adoption instead of becoming a bottleneck.",
    icon: PhBatteryCharging,
  },
  {
    label: "Assembly Growth",
    detail: "Local capability building to reduce cost, improve delivery speed, and expand market readiness.",
    icon: PhWrench,
  },
] as const;
</script>
...
<template>
  <div class="min-h-screen bg-[#fbfdfb] text-brand">
    ...
    <section class="mx-auto flex max-w-7xl flex-col gap-14 px-5 pb-16 pt-34 sm:px-8 lg:px-12 lg:pb-24 lg:pt-40">
      <div class="page-reveal reveal-delay-1 space-y-8">
        <div class="space-y-6">
          ...
          <p class="max-w-3xl text-sm leading-7 text-[#41555d] sm:text-base">
            Metropolitan Electric exists to move electric mobility from aspiration to operating reality.
            That means designing around infrastructure, fleets, service support, and long-term adoption,
            not simply putting electric vehicles on display.
          </p>
        </div>
        ...
        <div class="grid gap-4 sm:grid-cols-3 lg:max-w-3xl lg:ml-auto">
          <div class="rounded-[1.75rem] border border-[#d5ddd2] bg-white/92 p-5 shadow-[0_18px_60px_rgba(16,32,39,0.06)] backdrop-blur-sm">
            <p class="text-[11px] uppercase tracking-[0.28em] text-[#6c8177]">Mission</p>
            <p class="mt-3 font-opensans text-3xl font-semibold tracking-[-0.04em]">EV Access</p>
          </div>
          <div class="rounded-[1.75rem] border border-[#d5ddd2] bg-white/92 p-5 shadow-[0_18px_60px_rgba(16,32,39,0.06)] backdrop-blur-sm">
          ...
          <div class="grid gap-0 lg:grid-cols-[1.05fr_0.95fr]">
            <div class="relative overflow-hidden bg-brand p-6 text-white sm:p-8">
              ...
              <div class="relative space-y-5">
                ...
                <h2 class="max-w-6xl font-opensans text-3xl font-semibold tracking-[-0.045em] sm:text-4xl">
                  The future of electric mobility is operational, regional, and built for scale.
                </h2>
                <p class="max-w-3xl text-sm leading-7 text-white/72 sm:text-base">
                  We are focused on translating EV ambition into structured deployment across corporate fleets,
                  public transport systems, charging networks, local assembly, and long-term aftercare.
                </p>
              </div>
            </div>
            ...
            <div class="flex flex-col justify-between gap-6 p-6 sm:p-8">
              <div class="space-y-4">
                ...
                <p class="text-sm leading-7 text-[#41555d] sm:text-base">
                  Transport systems across Africa need cleaner, more resilient alternatives.
                  But transition only works when vehicles, charging, maintenance, local capability,
                  and business logic are treated as one connected system.
                </p>
                <p class="text-sm leading-7 text-[#41555d] sm:text-base">
                  Metropolitan Electric is built around that integration. We combine EV products,
                  service layers, and infrastructure thinking into a more durable path for adoption.
                </p>
              </div>
        ...
        <div class="grid gap-4">
          ...
          >
            <div class="flex items-start gap-4">
              <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[radial-gradient(circle_at_30%_30%,#7ca78d,#26414d_72%)] text-white shadow-[0_14px_30px_rgba(16,32,39,0.12)]">
      ...
      <section class="space-y-6">
        <div class="page-reveal reveal-delay-3 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <p class="max-w-xl text-sm leading-7 text-[#41555d]">
            The brand is grounded in sustainability, reliability, infrastructure awareness, and practical deployment logic.
          </p>
        </div>
      ...
      <section class="grid gap-8 lg:grid-cols-[0.92fr_1.08fr]">
        <div class="page-reveal reveal-delay-4 rounded-4xl border border-[#d8dfd5] bg-brand p-6 text-white shadow-[0_24px_80px_rgba(16,32,39,0.12)] sm:p-8">
          ...
          <h2 class="mt-3 font-opensans text-3xl font-semibold tracking-[-0.045em]">
            One mobility company, multiple EV layers.
          </h2>
          <p class="mt-4 text-sm leading-7 text-white/72 sm:text-base">
            The company is structured around the broader EV ecosystem. Each layer reinforces the others,
            creating a more complete route to adoption across private, institutional, and public transport use cases.
          </p>
        </div>

        <div class="grid gap-4">
          <article
            v-for="(item, index) in operatingModel"
            :key="item.label"
            class="page-reveal page-reveal-soft rounded-[1.75rem] border border-[#d8dfd5] bg-white/92 p-5 shadow-[0_16px_50px_rgba(16,32,39,0.05)] backdrop-blur-sm"
      ...
      <section class="overflow-hidden rounded-[2.25rem] border border-[#d3dbd0] bg-[linear-gradient(135deg,#0f181f_0%,#17332a_55%,#50654f_100%)] px-6 py-10 text-white shadow-[0_28px_90px_rgba(16,32,39,0.16)] sm:px-10 sm:py-14">
        ...
        <div class="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div class="max-w-3xl space-y-4">
            ...
            <h2 class="font-opensans text-3xl font-semibold tracking-[-0.05em] sm:text-4xl lg:text-5xl">
              See how the brand translates into vehicles, services, and deployment pathways.
            </h2>
            <p class="max-w-2xl text-sm leading-7 text-white/72 sm:text-base">
              Browse the vehicle gallery, explore the EV service stack, or contact the team to discuss a specific mobility plan.
            </p>
          </div>
