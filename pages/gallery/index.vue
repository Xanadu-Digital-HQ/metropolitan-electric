...
<template>
  <div class="min-h-screen bg-[#fbfdfb] text-[#102027]">
    ...
    <section :class="[container, 'flex flex-col gap-10 pb-16 pt-34 lg:pb-24 lg:pt-40']">
      <div class="flex flex-col gap-8 lg:gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div class="page-reveal reveal-delay-1 max-w-4xl space-y-5">
          ...
          <p class="max-w-3xl text-sm leading-7 text-[#41555d] sm:text-base">
            Browse our growing lineup of electric vehicles built for performance, efficiency, and
            real-world use.
          </p>
        </div>

        <div
          class="page-reveal reveal-delay-2 grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 gap-4 w-full md:w-fit"
        >
          <div
          ...
          <div
            class="rounded-[1.75rem] border border-brand/8 bg-brand p-5 text-white shadow-[0_24px_80px_rgba(16,32,39,0.16)] col-span-1 xs:col-span-full sm:col-span-1 lg:col-span-full"
          >
      ...
      <div
        class="page-reveal reveal-delay-3 rounded-4xl border border-[#d8dfd5] bg-white/86 p-4 shadow-[0_24px_80px_rgba(16,32,39,0.07)] backdrop-blur-sm sm:p-5"
      >
        <div
          class="category-scroll flex gap-3 overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
        >
          <button
            ...
            >
              <div class="relative flex items-start justify-between gap-4">
                <div class="space-y-3">
                  <p
                    ...
                    :class="
                      activeVehicle?.name === vehicleItem.name ? 'text-white/50' : 'text-[#6b8177]'
                    "
                  >
              ...
              <div class="mt-5 flex items-end justify-between gap-4">
                <p
                  ...
                  :class="
                    activeVehicle?.name === vehicleItem.name ? 'text-white/68' : 'text-[#475a61]'
                  "
                >
              ...
              <div
                ...
                :class="
                  activeVehicle?.name === vehicleItem.name ? 'border-white/10' : 'border-[#e4ebe1]'
                "
              >
                <span
                  class="text-xs uppercase tracking-[0.24em]"
                  :class="
                    activeVehicle?.name === vehicleItem.name ? 'text-white/45' : 'text-[#72877d]'
                  "
                >
                  Starting Price
                </span>
          ...
          <div class="mt-8 space-y-4">
            ...
            <div class="rounded-3xl bg-[#fbfdfb] p-4">
              ...
              <p class="mt-2 text-lg font-medium text-brand">
                {{
                  activeVehicle.specification.find((item) => item.label === 'RANGE')?.value ??
