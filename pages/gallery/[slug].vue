...
const activeImage = computed(() => {
  return activeVehicle.value?.images[currentImageIndex.value] ?? activeVehicle.value?.images[0] ?? "";
});
  ...
  <div class="min-h-screen bg-[#fbfdfb] text-[#102027]">
    ...
    <section v-if="activeVehicle" class="mx-auto flex max-w-7xl flex-col gap-8 px-5 pb-16 pt-34 sm:px-8 lg:px-12 lg:pb-24 lg:pt-40">
      ...
      <div class="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
        <div class="page-reveal reveal-delay-2 rounded-[2.2rem] border border-[#d8dfd5] bg-white/92 p-5 shadow-[0_28px_90px_rgba(16,32,39,0.08)] backdrop-blur-sm sm:p-8">
          ...
          <div class="mt-6 rounded-[1.8rem] bg-[radial-gradient(circle_at_top,#ffffff,#e7eee7_64%,#dde5de_100%)] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.7)] sm:p-6">
            <img
              :src="activeImage"
        ...
        <div class="flex flex-col gap-8">
          <section class="page-reveal reveal-delay-3 rounded-[2rem] bg-[#101920] p-6 text-white shadow-[0_24px_80px_rgba(16,32,39,0.12)] sm:p-8">
            ...
            <div class="mt-8 grid gap-3 sm:grid-cols-2">
              ...
              >
                <p class="text-[11px] uppercase tracking-[0.24em] text-white/40">{{ spec.label }}</p>
