    ...
    <section :class="[container, 'flex flex-col gap-10 pb-14 pt-34 lg:pb-20 lg:pt-40']">
      ...
      <div class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div class="flex flex-col gap-8">
          <section
            class="page-reveal reveal-delay-4 rounded-4xl bg-brand p-6 text-white shadow-[0_24px_80px_rgba(16,32,39,0.12)] sm:p-8"
          >
          ...
          <section
            class="page-reveal reveal-delay-5 rounded-4xl border border-[#d8dfd5] bg-white/92 p-6 shadow-[0_20px_70px_rgba(16,32,39,0.07)] backdrop-blur-sm sm:p-8"
          >
