...
<template>
  <span class="group relative">
    <button
      ...
      :class="
        item.state === 'button'
          ? 'relative z-10 py-2.5 px-7 text-sm font-medium font-main bg-accent/90 group-hover/overall:bg-accent group-hover/overall:text-white text-white rounded-full transition duration-300 hover:bg-accent/80'
          : navLinkStyle
      "
    >
