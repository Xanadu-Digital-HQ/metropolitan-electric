    ...
    >
      <div class="relative flex items-center justify-center">
        ...
        <button
          ...
          :class="
            radialVisible ? 'pointer-events-auto opacity-100' : 'pointer-events-none opacity-0'
          "
        ...
        >
          ...
          >
            <span
              class="px-2 font-opensans text-xxs font-bold leading-tight tracking-[0.14em] text-brand uppercase"
            >
              {{ link.shortLabel }}
            </span>
          </span>
        ...
        >
          <NuxtImg
            src="/wheel.svg"
            alt=""
            class="relative z-10 size-5 md:size-8 object-contain invert"
          />
        </button>
      </div>
    </div>
