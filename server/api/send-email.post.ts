            ...
            <tr>
              <td align="center">
                <table role="presentation" class="email-card" width="640" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="header">
                      <img src="https://metropolitanelectricng.com/metro_logo_white.png" width="120" alt="Metropolitan Electric" class="brand-logo" style="display:block; width:120px; max-width:100%; height:auto;">
